...
#pragma unroll
    for (int k_block = 0; k_block < K_BLOCK_MAX; k_block++) {
      ...
      COMPUTE_1X8_K2(tCrC[0], tCrA[rmem_pipe_read][0], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], x);
      COMPUTE_1X8_K2(tCrC[1], tCrA[rmem_pipe_read][0], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], y);
      COMPUTE_1X8_K2(tCrC[2], tCrA[rmem_pipe_read][0], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], z);
      COMPUTE_1X8_K2(tCrC[3], tCrA[rmem_pipe_read][0], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], w);

      COMPUTE_1X8_K2(tCrC[4], tCrA[rmem_pipe_read][1], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], x);
      COMPUTE_1X8_K2(tCrC[5], tCrA[rmem_pipe_read][1], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], y);
      COMPUTE_1X8_K2(tCrC[6], tCrA[rmem_pipe_read][1], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], z);
      COMPUTE_1X8_K2(tCrC[7], tCrA[rmem_pipe_read][1], tCrB[rmem_pipe_read][0],
                     tCrB[rmem_pipe_read][1], w);
