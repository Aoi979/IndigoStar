...
namespace custom::trial {

inline constexpr int kTrialSmemBytes = 64 * 1024;

__global__ void sgemm_128x128x32_trial(int M, int N, int K,
  ...
  constexpr int TrialSmemNumel = kTrialSmemBytes / sizeof(float);
  constexpr int TrialPadNumel = TrialSmemNumel - ASmemNumel - BSmemNumel;
  static_assert(TrialPadNumel >= 0);
