...
#include "cute_ampere_hgemm_16816_no_reg_prefetch.cuh"

namespace cute_hgemm {

inline cudaError_t launch_hgemm_128x128_nn_no_reg_prefetch(
    const cute::half_t *A, const cute::half_t *B, cute::half_t *C,
  ...
  auto kernel_fptr = cute_ampere_hgemm_16816_no_reg_prefetch<
