...
__global__ void sgemm_128x128x32_K4(int M, int N, int K,
  ...
  for (int k_tile = 0; k_tile < K_TILE_MAX; ++k_tile) {
    ...
    for (int k_block = 0; k_block < kBK; k_block += MMA_K) {
      ...
      COMPUTE_1X8_K4(tCrC[0], tCrA[0], tCrB[0], tCrB[1], x);
      COMPUTE_1X8_K4(tCrC[1], tCrA[0], tCrB[0], tCrB[1], y);
      COMPUTE_1X8_K4(tCrC[2], tCrA[0], tCrB[0], tCrB[1], z);
      COMPUTE_1X8_K4(tCrC[3], tCrA[0], tCrB[0], tCrB[1], w);

      COMPUTE_1X8_K4(tCrC[4], tCrA[1], tCrB[0], tCrB[1], x);
      COMPUTE_1X8_K4(tCrC[5], tCrA[1], tCrB[0], tCrB[1], y);
      COMPUTE_1X8_K4(tCrC[6], tCrA[1], tCrB[0], tCrB[1], z);
      COMPUTE_1X8_K4(tCrC[7], tCrA[1], tCrB[0], tCrB[1], w);
    }
  }
